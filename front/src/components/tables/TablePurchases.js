...
class TablePurchases extends React.Component
{
    constructor(props) {
        super(props);
        this.state = {
                headers: ["purchaseId","customerId","count","productId"],
                content: []
            }
    }
    ...
    render(){
        ...
        for(i = 0; i < content.length; ++i){
            ...
            const buttonsDiv = <td key={'buttons ' + i}><div>
                <Button variant='danger' onClick={() => this.deletePurchase(curcontent['purchaseId'])}>
